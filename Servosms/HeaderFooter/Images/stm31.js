...
if(nNN4)
{	
	doitovNN4=getEventCode('doitov',1);
	doitouNN4=getEventCode('doitou',1);
	doitckNN4=getEventCode('doitck',1);
	dombovNN4=getEventCode('dombov',0);
	dombouNN4=getEventCode('dombou',0);	
}
...
function endSTM()
{
	...
	if(nSTMENU&&!(nIEM||(nIEW&&nVer<5.0)))
	{
		...
		if(st_ht!='')
		{
			...
			else
			{
				...
				//alert("422:"+obj.document);//added by vishnu 9.07.08
			}
			st_gcount++;
			st_ht='';
		}
	...
	//alert("431");//added by vishnu 9.07.08
}
...
function getBodyTextH(body)
{
	...
	//alert("498"+document.getElementById(body.block));
	//alert("498:"+document.getElementsByName(body.block));
...
//	for(var j=0;j<menusv.length;j++)
//	{
//		alert("menus:"+menusv[j]);
//	}
	...
	{	
		...
		for(iti=0;iti<body.items.length;iti++)
		{
			...
			for(var j=0;j<menusv.length;j++)
			{
				if(menusv[j]==it.text&&it.text==item.text)
				{
					//alert("test menu:"+getsub(item));
					//alert("906 item.type:"+it.text+":"+menusv[j]+",mbi:"+mbi+",iti:"+iti+"j:"+j)
					a=j;
					mf=true
					break;
				}
	   ...
	   // alert("c1:"+c1+"a:"+a);
    	...
    	//alert("iti:"+iti+"itm:"+itm);

	//alert("976 mbi:"+mbi+"mb:"+mb+"iti:"+iti+"itm:"+itm+"c1"+c1);
	...
	//alert("1001 mbi:"+mbi+"mb:"+mb+"iti:"+iti+"itm:"+itm+"c1"+c1);
	...
	for(mbi=0;mbi<menu.bodys.length;mbi++)
	{
		...
		for(iti=0;iti<body.items.length;iti++)
		{
				...
				if(key==(49+iti)) //with out alt key
				//if(key==(49+iti)&&e.altKey)
				{
					f=true;
					itv=body.items[iti]
					obj=itv.layer;
					//alert("mbi"+mbi+"920 item"+itv.text);
					it=itv;
					i=i+iti;
					f2=false;
					break;
				...
				if(it==item)
				{
					if(key==39&&f2==false)//right
					{	
						//alert("1011 key==39&&f2==false item"+item.text+" mbi:"+mbi+"iti:"+iti);
						f=true;
						if(iti== body.items.length-1)return;
						itv=body.items[iti+1]
						obj=itv.layer;
						//alert("920 item"+itv.text);
						it=itv;
						i++;
						break;
					}
					else if(key==37 &&f2==false)//left
					{	
					//	alert("1022 key==37 &&f2==false item"+item.text+" mbi:"+mbi+"iti:"+iti);
						f=true;
						//alert("iti"+iti);
						if(iti== 0)return;
					...
					else if(key==39&&f2==true)//right
					{	
						//alert("1023 key==39&&f2==true item"+item.text+" mbi:"+mbi+"iti:"+iti);
						//f=true;
						//var vi= getpar(item).arrange=="vertically";
						//alert("1051vi :"+getsub(item));
						//if(vi==false)
						...
						if(getsub(it)!=null)
						 {
							//body=menu.bodys[mbi+1]
							//item=body.items[iti];
						
							flagsub=true;

							mbtemp=mbi;//added on 07.07
							ittemp=iti;	
							
							//alert("mb:"+mb);
							
							body=menu.bodys[mb+1]
							//body=menu.bodys[mb]

							item=body.items[0];				

							//alert("1038:"+ item.text);
					...
					//else if(key==37 &&f2==true&& flagsub==true)//left
					else if(key==37 &&f2==true)//left
					{	
						//alert("flagsub:"+flagsub);
						if(flagsub==true)
						{
						    f=true;
							var vi
							//alert("1062 key==37&&f2==true item"+item.text+" mbi:"+mbi+"iti:"+iti);
							
							 vi= getpar(item).arrange=="vertically";
							 //return;
							//}
						   //alert("1092 vi :"+vi);
							
							body=menu.bodys[mbtemp]
							item=body.items[ittemp];
							//alert("item:"+item)
							if(item==null)
							{
								return;
							}
							//alert("1078 item"+item.text);
						    //alert("1097:"+getsub(item));
							if(getsub(item)!=null)
							{
								obj=item.layer;
					...
					{	
						var vi= getpar(item).arrange=="vertically";
						//alert("1126 key==40 item"+item.text+" mbi:"+mbi+"iti:"+iti);
						//alert("895vi :"+vi);
						//alert("895sub :"+getsub(item))
						/*if(getsub(it)!=null)
						{
							mbtemp=mb;
							ittemp=iti;
							alert("mbtemp:"+mbtemp+":"+iti);
						}*/
						...
						if(vi==false)
						 {
							...
							{
								body=menu.bodys[mbi+4]
								item=body.items[iti-1];
								obj=item.layer;
							}*/
							//alert("40 if 1116mb"+mb);
							//alert("1117itm"+itm);
						...
						else
						{
							...
							//alert("1117itm"+itm);
							//alert("40 if 1116mb"+mb+"item"+item.layer);
							//if(body.items[iti+1].layer!=null)
							if(iti== body.items.length-1)
								return;
							item=body.items[iti+1];

							//if(body.items[iti+2].layer!=null)
							//if(body.items[iti+1].layer!=null)
								obj=item.layer;
								f=true;
							itv=item
					  ...
					  {	
						//alert("1181 key==38 item"+item.text+" mbi:"+mbi+"iti:"+iti);
						var vi= getpar(item).arrange=="vertically";
						...
						else
						{
							...
							if(iti>0)
								item=body.items[iti-1];
							//alert("item.layer"+item.layer);
							if(item.layer!=null)
							{
								obj=item.layer;
								//alert("910 item"+item.text);
								f=true;
								itv=item
								it=itv;	
							}
...
function doitck(e,obj,it)
{
	...
	//*******************
	//alert(e.button&&e.button>=2)
	if(e.button&&e.button>=2)
		return;
	//alert(getpar(it).isclick)

	if(getpar(it).isclick)
	{
		//alert(getme(it).clicked)
	...
	if(!(getpar(it).isclick&&getsub(it)))
	{
		if(it.url!="")
		{
			...
			else if(it.target=="_self")//add this condition for handle all the forms in manubar(page loading problem)//Vishnu Sir
				window.location.href=it.url;
			else
...
//*added by Vishnu 07.07.08

function doitkey(e,obj,it)
{
	//*******************
	if(window.event) 
	{
	...
	if(key==32)//&& e.ctrlKey)
	{
		...
		{
			var _preurl="javascript:";
			if(itv.url.toLowerCase().indexOf(_preurl)==0)
				eval(itv.url.substring(_preurl.length,itv.url.length));
			else if(nNN6&&itv.target=="_self")
				window.location.href=itv.url;
			else if(itv.target=="_self")//add this condition for handle all the forms in manubar(page loading problem)//Vishnu Sir
				window.location.href=itv.url;
			else
				window.open(itv.url,itv.target);
		}
	}

	if(key==120||key==88)
	{
		window.open("/Servosms/Login.aspx","_self");
	}
	else if(key==104||key==72)
	{
		window.open("/Servosms/HomePage.aspx","_self");
	}
}
...
function shitpop(item)
{
	if(getsub(item))
	{
		//alert("shitpop getsub:"+item.text);
...
function getob(id,t)
{
	...
	{
		//alert("2436:"+(t ? document.all.tags(t)[id] : document.all[id]));
...
function getBodyEventString(body)
{
	...
	s=" onkeydown='dombov(event,this,st_menus["+body.mei+"].bodys["+body.mbi+"]);'";
...
function getItemEventString(item)
{
	...
	//***************
	//var s=" onkeydown='doitovk(event,this,st_menus["+item.mei+"].bodys["+item.mbi+"].items["+item.iti+"]);'";

	s+=" onkeyup='doitovk(event,this,st_menus["+item.mei+"].bodys["+item.mbi+"].items["+item.iti+"]);'";
	s+=" onkeypress='doitkey(event,this,st_menus["+item.mei+"].bodys["+item.mbi+"].items["+item.iti+"]);'";
	
	//s+=" onkeyup='doitck(event,this,st_menus["+item.mei+"].bodys["+item.mbi+"].items["+item.iti+"]);'";
	//***************
	//this.focus();
	//alert("On load"+document.all);
	//alert("2481:"+document.getElementsByName("vishnu"));
	//alert("2481:"+document.form.getElementsByName("vishnu"));
	/*try
	{
	...
	//alert("2491:"+document.getElementById("STM0_8_6_LLTDI"));
...
function setFocus()
{
	...
	try
	{
		//document.getElementById("STMO_0_0").focus();
		document.getElementById("STM0_0__0___").focus();
	}
	catch(e)
	{
